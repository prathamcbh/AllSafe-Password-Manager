...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class MainTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet.MainDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet.MainDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet.MainDataTable = New Database1DataSet.MainDataTable()
